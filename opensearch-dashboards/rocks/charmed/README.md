...
This directory contains the packaging metadata for creating a Charmed OpenSearch Dashboards rock derived from the [opensearch-dashboards-charmed Snap](https://github.com/canonical/opensearch-artifacts/tree/main/opensearch-dashboards/snaps/charmed). Compared to the [standard rock](../standard), this variant bundles the Prometheus exporter for OpenSearch Dashboards. For more information on rocks, visit the [rockcraft Github](https://github.com/canonical/rockcraft).
...
docker pull ghcr.io/canonical/opensearch-charmed:${version}-${base#*@}_edge
...
opensearch_cont=$(docker run -d --rm \
    ...
    ghcr.io/canonical/opensearch-charmed:${version}-${base#*@}_edge
)
