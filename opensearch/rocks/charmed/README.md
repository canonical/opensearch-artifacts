...
This directory contains the packaging metadata for creating a rock of [OpenSearch](https://opensearch.org/) built from the [opensearch-charmed snap](../../snaps/charmed), for use by the [OpenSearch charms](https://github.com/canonical/opensearch-operator). A rock is an Open Container Initiative (OCI) image; for more information on rocks, visit the [rockcraft Github](https://github.com/canonical/rockcraft).

This variant keeps the full bundled plugin set of the charmed snap, including
`opensearch-knn` and `opensearch-performance-analyzer`.
...
```bash
docker pull ghcr.io/canonical/opensearch-charmed:3.7.0-26.04_edge
```
...
## License
The OpenSearch Charmed rock is free software, distributed under the Apache
