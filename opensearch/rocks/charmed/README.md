...
The [Charmed OpenSearch rock](https://github.com/canonical/opensearch-artifacts) is an Open Container Initiative (OCI) image derived from the [opensearch-charmed Snap](https://snapcraft.io/opensearch-charmed). The tool used to create this rock is called [Rockcraft](https://canonical-rockcraft.readthedocs-hosted.com/en/latest/index.html).

This repository contains the packaging metadata for creating the Charmed OpenSearch rock. This rock image is based on the [opensearch-charmed Snap](https://github.com/canonical/opensearch-artifacts/tree/add-charmed-3-edge-rock/opensearch/snaps/charmed).
...
The Charmed OpenSearch rock is free software, distributed under the Apache Software License, version 2.0. See [LICENSE](https://github.com/canonical/opensearch-artifacts/blob/main/LICENSE) for more information.
